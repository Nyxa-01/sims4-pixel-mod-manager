...
class PixelProgressBar(tk.Canvas):
    ...
    def __init__(self, parent, segments: int = 20, width: int = 400, height: int = 32, **kwargs):
        ...
        """
        super().__init__(
            parent, width=width, height=height, bg="#1a1a1a", highlightthickness=0, **kwargs
        )
    ...
    def _render(self) -> None:
        ...
        # Border
        self.create_rectangle(
            2, 2, self.winfo_width() - 2, self.winfo_height() - 2, outline="#00e0ff", width=2
        )
