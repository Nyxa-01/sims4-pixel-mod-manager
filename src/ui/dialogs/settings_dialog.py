...
class SettingsDialog(tk.Toplevel):
    ...
    def _build_ui(self) -> None:
        ...
        tk.Label(
            content, text="📂 Paths", font=("Courier New", 10, "bold"), fg="#00e0ff", bg="#1a1a1a"
        ).pack(pady=5)

        # Game path
        tk.Label(
            content, text="Game Install:", font=("Courier New", 9), fg="#00ff00", bg="#1a1a1a"
        ...
        # Mods path
        tk.Label(
            content, text="Mods Folder:", font=("Courier New", 9), fg="#00ff00", bg="#1a1a1a"
